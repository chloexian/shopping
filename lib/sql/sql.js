class SQL {
	...
	insertOneForShopcart (o) {
		return "INSERT INTO `t_shopcart`(`imgUrl`,`pname`,`price`,`count`,`email`,`nickname`,`cartTime`,`proid`) VALUES('"+ o.imgUrl + "','"+ o.pname + "','" + o.price + "','" + o.count + "','" + o.email + "','" + o.nickname + "','" + o.cartTime + "'," + o.proid +")";
	}
